...
public class Pokedex {
    ...
    public static Pokemon charizard() {
        return new Pokemon("Charizard", 180, 84, 109, 78, 85, 100, 50, Tipo.FIRE,
                Arrays.asList(
    ...
    public static Pokemon arcanine() {
        return new Pokemon("Arcanine", 180, 110, 80, 90, 80, 95, 50, Tipo.FIRE,
                Arrays.asList(
                        new Movimiento("Lanzallamas", 90, Tipo.FIRE, 100, 15),
    ...
    public static Pokemon blastoise() {
        return new Pokemon("Blastoise", 200, 83, 100, 100, 85, 78, 50, Tipo.WATER,
                Arrays.asList(
    ...
    public static Pokemon lapras() {
        return new Pokemon("Lapras", 200, 85, 95, 80, 125, 60, 50, Tipo.WATER,
                Arrays.asList(
                        new Movimiento("Hidrobomba", 110, Tipo.WATER, 80, 5),
                        new Movimiento("Hielo Rayo", 90, Tipo.ICE, 100, 10),
                        new Movimiento("Terremoto", 100, Tipo.GROUND, 100, 10),
    ...
    public static Pokemon gyarados() {
        return new Pokemon("Gyarados", 200, 125, 79, 100, 80, 81, 50, Tipo.WATER,
                Arrays.asList(
                        new Movimiento("Hidrobomba", 110, Tipo.WATER, 80, 5),
    ...
    public static Pokemon venusaur() {
        return new Pokemon("Venusaur", 180, 82, 100, 83, 100, 80, 50, Tipo.GRASS,
                Arrays.asList(
    ...
    public static Pokemon pikachu() {
        return new Pokemon("Pikachu", 140, 55, 90, 40, 50, 90, 50, Tipo.ELECTRIC,
                Arrays.asList(
                        new Movimiento("Rayo", 90, Tipo.ELECTRIC, 100, 15),
    ...
    public static Pokemon alakazam() {
        return new Pokemon("Alakazam", 165, 70, 125, 65, 95, 120, 50, Tipo.PSYCHIC,
                Arrays.asList(
    ...
    public static Pokemon machamp() {
        return new Pokemon("Machamp", 180, 130, 65, 100, 85, 55, 50, Tipo.FIGHTING,
                Arrays.asList(
    ...
    public static Pokemon dragonite() {
        return new Pokemon("Dragonite", 200, 134, 100, 95, 100, 80, 50, Tipo.DRAGON,
                Arrays.asList(
    ...
    public static Pokemon snorlax() {
        return new Pokemon("Snorlax", 250, 110, 65, 65, 110, 30, 50, Tipo.NORMAL,
                Arrays.asList(
